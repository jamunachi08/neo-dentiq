...
def install_theme():
	"""Materialise the default theme so its colour tables exist and are editable."""
	theme = frappe.get_single("Neo Dentiq Theme")
	theme.flags.ignore_mandatory = True
	theme.seed_tables()
	if not theme.primary_colour:
		theme.apply_preset_values(theme.theme_preset or "Clinical Mint")
